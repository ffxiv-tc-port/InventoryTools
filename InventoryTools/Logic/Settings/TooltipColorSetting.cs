...
namespace InventoryTools.Logic.Settings
{
    public class TooltipColorSetting : GameColorSetting
    {
        ...
        public override string Name { get; set; } = "Text Colour".Loc();
        public override string HelpText { get; set; } = "This is the colour of any text added to the item tooltip. You can give each tooltip module it's own colour by going into the tooltip's settings.".Loc();
