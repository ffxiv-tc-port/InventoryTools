...
public class UseIconGroupingSetting : Setting<Dictionary<Type, bool>?>
{
    ...
    public override string Name { get; set; } = "Use Acquisition Icon Grouping".Loc();
    public override string HelpText { get; set; } = "When use acquisition icons are displayed, how should they be grouped?".Loc();
