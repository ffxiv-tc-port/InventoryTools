...
public class HotkeyConfigWindowSetting : HotKeySetting
{
    ...
    public override string Name { get; set; } = "Toggle Configuration Window".Loc();
    public override string HelpText { get; set; } = "The hotkey to toggle the configuration window.".Loc();
