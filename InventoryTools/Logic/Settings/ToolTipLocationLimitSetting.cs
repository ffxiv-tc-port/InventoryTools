...
public class ToolTipLocationLimitSetting : IntegerSetting
{
    ...
    public override string Name { get; set; } = "Add Item Locations (Max Results)".Loc();
    public override string HelpText { get; set; } = "The maximum amount of locations to list on the tooltip. This requires 'Display Amount Owned?' to be enabled.".Loc();
