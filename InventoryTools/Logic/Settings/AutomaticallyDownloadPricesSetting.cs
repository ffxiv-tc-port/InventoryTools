...
namespace InventoryTools.Logic.Settings
{
    public class AutomaticallyDownloadPricesSetting : BooleanSetting
    {
        ...
        public override string Name { get; set; } = "Automatically download prices?".Loc();

        public override string WizardName { get; } = "Download Pricing Data".Loc();
        public override string HelpText { get; set; } = "Should price data be automatically downloaded when it's viewed in a list?".Loc();
