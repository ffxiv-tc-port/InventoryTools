...
public class TooltipCategoryWhitelistSetting : MultipleChoiceSetting<uint>
{
    ...
    public override string Name { get; set; } = "Tooltip Category Whitelist".Loc();
    public override string HelpText { get; set; } = "When adding information to tooltips, should we limit the items affected to these categories? If 'Tooltip Category Blacklist` is checked, this functionality will be reversed.".Loc();
