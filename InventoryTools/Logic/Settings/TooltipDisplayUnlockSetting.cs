...
public class TooltipDisplayUnlockSetting : BooleanSetting
{
    ...
    public override string Name { get; set; } = "Add Item Unlock Status".Loc();
    public override string HelpText { get; set; } = "If an item can be unlocked/acquired, shows if your characters have unlocked/acquired said item. Can be configured to show specific characters inside the configuration window.".Loc();
