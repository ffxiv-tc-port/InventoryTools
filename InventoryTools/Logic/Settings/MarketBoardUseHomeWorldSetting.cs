...
public class MarketBoardUseHomeWorldSetting : BooleanSetting
{
    ...
    public override string Name { get; set; } = "Price Home World?".Loc();
    public override string HelpText { get; set; } = "Should your character's home world be automatically priced?".Loc();
