...
public class TooltipDisplayUnlockCharacterSetting : MultipleChoiceSetting<ulong>
{
    ...
    public override string Name { get; set; } = "Add Item Unlock Status (Characters)".Loc();
    public override string HelpText { get; set; } = "When showing the unlock status on items, these characters will be displayed. Leave empty to display all characters.".Loc();
