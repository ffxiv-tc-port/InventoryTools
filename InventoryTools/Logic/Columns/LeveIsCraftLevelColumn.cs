...
namespace InventoryTools.Logic.Columns
{
    public class LeveIsCraftLevelColumn : CheckboxColumn
    {
        ...
        public override string Name { get; set; } = "Is Leve(Craft) Item?".Loc();
        public override string RenderName => "Leve (Craft)".Loc();
        public override float Width { get; set; } = 100.0f;
        public override string HelpText { get; set; } = "Is this item used in a craft leve?".Loc();
