...
namespace InventoryTools.Logic.Columns
{
    public class EquippableByGenderColumn : TextColumn
    {
        ...
        public override string Name { get; set; } = "Equipped By (Gender)".Loc();
        public override float Width { get; set; } = 200;
        public override string HelpText { get; set; } = "Shows if an item can be equipped by a specific gender.".Loc();
