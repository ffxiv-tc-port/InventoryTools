...
namespace InventoryTools.Logic.Columns
{
    public class BuyFromVendorPriceColumn : GilColumn
    {
        ...
        public override string Name { get; set; } = "Buy from Vendor Price".Loc();
        public override float Width { get; set; } = 100.0f;
        public override string HelpText { get; set; } = "How much the item can be purchased from a vendor(gil)".Loc();
