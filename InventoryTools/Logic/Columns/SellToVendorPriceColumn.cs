...
namespace InventoryTools.Logic.Columns
{
    public class SellToVendorPriceColumn : GilColumn
    {
        ...
        public override string Name { get; set; } = "Sell to Vendor Price".Loc();
        public override float Width { get; set; } = 100.0f;
        public override string HelpText { get; set; } = "The amount this item can be sold to a vendor for(gil).".Loc();
