...
namespace InventoryTools.Logic.Columns
{
    public class IconColumn : GameIconColumn
    {
        ...
        public override string Name { get; set; } = "Icon".Loc();
        public override string RenderName => "";
        public override float Width { get; set; } = 60.0f;
        public override string HelpText { get; set; } = "Shows the icon of the item, pressing it will open the more information window for the item.".Loc();
