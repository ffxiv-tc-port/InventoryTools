...
public class HistoryChangeReasonColumn : TextColumn
{
    ...
    public override string Name { get; set; } = "History Event Reason".Loc();
    public override string RenderName => "Event".Loc();
    public override float Width { get; set; } = 100;
    public override string HelpText { get; set; } = "The reason the change occurred".Loc();
