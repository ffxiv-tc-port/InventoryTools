...
public class FromCalamitySalvagerColumn : CheckboxColumn
{
    ...
    public override string Name { get; set; } = "Is from Calamity Salvager?".Loc();
    public override float Width { get; set; } = 100;
    public override string HelpText { get; set; } = "Is this item available at a calmity salvager?".Loc();
