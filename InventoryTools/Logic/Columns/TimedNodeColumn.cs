...
namespace InventoryTools.Logic.Columns
{
    public class TimedNodeColumn : CheckboxColumn
    {
        ...
        public override string Name { get; set; } = "Is From Timed Node?".Loc();
        public override string RenderName => "Timed Node?".Loc();
        public override float Width { get; set; } = 125.0f;
        public override string HelpText { get; set; } = "Is this item available at a timed node?".Loc();
