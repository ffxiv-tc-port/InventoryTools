...
public class IsCustomDeliveryItemColumn : CheckboxColumn
{
    ...
    public override string Name { get; set; } = "Is custom delivery item?".Loc();
    public override string? RenderName { get; } = "Custom delivery item?".Loc();
    public override float Width { get; set; } = 80;
    public override string HelpText { get; set; } = "Is this item used for custom deliveries?".Loc();
