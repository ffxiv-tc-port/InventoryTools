...
public class ItemGcExpertDeliverySourceRenderer : ItemInfoRenderer<ItemGCExpertDeliverySource>
{
    ...
    public override string SingularName => "Grand Company Expert Delivery".Loc();
    public override string HelpText => "Can the item be handed in for 'Expert Delivery' at your grand company?".Loc();
