...
public class ItemSubmarineDropSourceRenderer : ItemInfoRenderer<ItemSubmarineDropSource>
{
    ...
    public override string SingularName => "Submarine Exploration".Loc();
    public override string HelpText => "Can the item be earned from a submarine exploration route?".Loc();
