...
public class ItemDesynthSourceRenderer : ItemSupplementSourceRenderer<ItemDesynthSource>
{
    ...
    public override string SingularName => "Desynthesis".Loc();
    public override string HelpText => "Can the item be obtained via desynthesis?".Loc();
}
...
public class ItemReductionSourceRenderer : ItemSupplementSourceRenderer<ItemReductionSource>
{
    ...
    public override string SingularName => "Reduction".Loc();
    public override string HelpText => "Can the item be obtained via reduction?".Loc();
}
...
public class ItemLootSourceRenderer : ItemSupplementSourceRenderer<ItemLootSource>
{
    ...
    public override string SingularName => "Loot".Loc();
    public override string HelpText => "Can the item be obtained from another item(normally a chest/material container/coffer)?".Loc();
}
...
public class ItemGardeningSourceRenderer : ItemSupplementSourceRenderer<ItemGardeningSource>
{
    ...
    public override string SingularName => "Gardening".Loc();
    public override string HelpText => "Can the item be grown via gardening?".Loc();
}
...
public class ItemDesynthUseRenderer : ItemSupplementUseRenderer<ItemDesynthSource>
{
    ...
    public override string SingularName => "Desynthesis".Loc();
    public override string HelpText => "Can the item be desynthesized?".Loc();
}
...
public class ItemReductionUseRenderer : ItemSupplementUseRenderer<ItemReductionSource>
{
    ...
    public override string SingularName => "Reduction".Loc();
    public override string HelpText => "Can the item be reduced?".Loc();
}
...
public class ItemLootUseRenderer : ItemSupplementUseRenderer<ItemLootSource>
{
    ...
    public override string SingularName => "Loot".Loc();
    public override string HelpText => "Does this item contain other items?".Loc();
}
...
public class ItemGardeningUseRenderer : ItemSupplementUseRenderer<ItemGardeningSource>
{
    ...
    public override string SingularName => "Gardening".Loc();
    public override string HelpText => "Can the item be used for gardening?".Loc();
}
...
public class ItemCardPackSourceRenderer : ItemSupplementSourceRenderer<ItemCardPackSource>
{
    ...
    public override string SingularName => "Card Pack".Loc();
    public override string HelpText => "Can the item be obtained from a card pack?".Loc();
}
...
public class ItemCardPackUseRenderer : ItemSupplementUseRenderer<ItemCardPackSource>
{
    ...
    public override string SingularName => "Card Pack".Loc();
    public override string HelpText => "Does this item contain cards?".Loc();
}
...
public class ItemCofferSourceRenderer : ItemSupplementSourceRenderer<ItemCofferSource>
{
    ...
    public override string SingularName => "Coffer".Loc();
    public override string HelpText => "Can the item be obtained from a coffer?".Loc();
}
...
public class ItemCofferUseRenderer : ItemSupplementUseRenderer<ItemCofferSource>
{
    ...
    public override string SingularName => "Coffer".Loc();
    public override string HelpText => "Is this an item coffer that contains other items?".Loc();
}
...
public class ItemPalaceOfTheDeadSourceRenderer : ItemSupplementSourceRenderer<ItemPalaceOfTheDeadSource>
{
    ...
    public override string SingularName => "Palace of the Dead".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in the Palace of the Dead?".Loc();
}
...
public class ItemPalaceOfTheDeadUseRenderer : ItemSupplementUseRenderer<ItemPalaceOfTheDeadSource>
{
    ...
    public override string SingularName => "Palace of the Dead".Loc();
    public override string HelpText => "Is this a loot item obtained in the Palace of the Dead?".Loc();
}
public class ItemHeavenOnHighSourceRenderer : ItemSupplementSourceRenderer<ItemHeavenOnHighSource>
{
    ...
    public override string SingularName => "Heaven on High".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in the Heaven on High?".Loc();
}
...
public class ItemHeavenOnHighUseRenderer : ItemSupplementUseRenderer<ItemHeavenOnHighSource>
{
    ...
    public override string SingularName => "Heaven on High".Loc();
    public override string HelpText => "Is this a loot item obtained in the Heaven on High?".Loc();
}
public class ItemEurekaOrthosSourceRenderer : ItemSupplementSourceRenderer<ItemEurekaOrthosSource>
{
    ...
    public override string SingularName => "Eureka Orthos".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in the Eureka Orthos?".Loc();
}
...
public class ItemEurekaOrthosUseRenderer : ItemSupplementUseRenderer<ItemEurekaOrthosSource>
{
    ...
    public override string SingularName => "Eureka Orthos".Loc();
    public override string HelpText => "Is this a loot item obtained in the Eureka Orthos?".Loc();
}
...
public class ItemAnemosSourceRenderer : ItemSupplementSourceRenderer<ItemAnemosSource>
{
    ...
    public override string SingularName => "Eureka Anemos".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in Eureka Anemos?".Loc();
}
...
public class ItemAnemosUseRenderer : ItemSupplementUseRenderer<ItemAnemosSource>
{
    ...
    public override string SingularName => "Eureka Anemos".Loc();
    public override string HelpText => "Is this a loot item obtained in the Eureka Anemos?".Loc();
}
public class ItemPagosSourceRenderer : ItemSupplementSourceRenderer<ItemPagosSource>
{
    ...
    public override string SingularName => "Eureka Pagos".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in Eureka Pagos?".Loc();
}
...
public class ItemPagosUseRenderer : ItemSupplementUseRenderer<ItemPagosSource>
{
    ...
    public override string SingularName => "Eureka Pagos".Loc();
    public override string HelpText => "Is this a loot item obtained in the Eureka Pagos?".Loc();
}
public class ItemPyrosSourceRenderer : ItemSupplementSourceRenderer<ItemPyrosSource>
{
    ...
    public override string SingularName => "Eureka Pyros".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in Eureka Pyros?".Loc();
}
...
public class ItemPyrosUseRenderer : ItemSupplementUseRenderer<ItemPyrosSource>
{
    ...
    public override string SingularName => "Eureka Pyros".Loc();
    public override string HelpText => "Is this a loot item obtained in the Eureka Pyros?".Loc();
}
...
public class ItemHydatosSourceRenderer : ItemSupplementSourceRenderer<ItemHydatosSource>
{
    ...
    public override string SingularName => "Eureka Hydatos".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in Eureka Hydatos?".Loc();
}
...
public class ItemHydatosUseRenderer : ItemSupplementUseRenderer<ItemHydatosSource>
{
    ...
    public override string SingularName => "Eureka Hydatos".Loc();
    public override string HelpText => "Is this a loot item obtained in the Eureka Hydatos?".Loc();
}
...
public class ItemBozjaSourceRenderer : ItemSupplementSourceRenderer<ItemBozjaSource>
{
    ...
    public override string SingularName => "Bozja".Loc();
    public override string HelpText => "Can the item be obtained from a loot item in Bozja?".Loc();
}
...
public class ItemBozjaUseRenderer : ItemSupplementUseRenderer<ItemBozjaSource>
{
    ...
    public override string SingularName => "Bozja".Loc();
    public override string HelpText => "Is this a loot item obtained in the Bozja?".Loc();
}
public class ItemLogogramSourceRenderer : ItemSupplementSourceRenderer<ItemLogogramSource>
{
    ...
    public override string SingularName => "Logogram".Loc();
    public override string HelpText => "Can the item be obtained from a logogram?".Loc();
}
...
public class ItemLogogramUseRenderer : ItemSupplementUseRenderer<ItemLogogramSource>
{
    ...
    public override string SingularName => "Logogram".Loc();
    public override string HelpText => "Is this item a logogram?".Loc();
