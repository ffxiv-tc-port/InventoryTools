...
public class ItemGCShopUseRenderer : ItemGCShopSourceRenderer
{
    ...
    public override string HelpText => "Can the item be spent at a grand company shop?".Loc();
...
public class ItemGCShopSourceRenderer : ItemInfoRenderer<ItemGCShopSource>
{
    ...
    public override string SingularName => "Grand Company Shop".Loc();
    public override string PluralName => "Grand Company Shops".Loc();
    public override string HelpText => "Can the item be purchased at your grand company shop?".Loc();
    ...
    public override Action<ItemSource> DrawTooltip => source =>
    {
        ...
        ImGui.SameLine();
        ImGui.Text("Cost: ?? x ??".Loc(asSource.CostItem.NameString, asSource.GCScripShopItem.Base.CostGCSeals));
        if (asSource.GCScripShopItem.Base.RequiredGrandCompanyRank.IsValid)
        {
            var genericRank = _rankSheet
                ...
                .ToTitleCase();
            ImGui.Text("Rank Required: ".Loc() + genericRank);
        }
