...
namespace InventoryTools.Logic.Filters
{
    public class DestinationIncludeCrossCharacterFilter : BooleanFilter
    {
        ...
        public override string Name { get; set; } = "Destination - Cross Character?".Loc();
        public override string HelpText { get; set; } = "Should items be sorted cross character? Will default to using the default configuration in the main allagan tools configuration if not selected.".Loc();
