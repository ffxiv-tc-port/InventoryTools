...
namespace InventoryTools.Logic.Filters
{
    public class DestinationAllRetainersFilter : BooleanFilter
    {
        ...
        public override string Name { get; set; } = "Destination - All Retainers?".Loc();
        public override string HelpText { get; set; } = "Use every retainer's inventory as a destination.".Loc();
