...
namespace InventoryTools.Logic.Filters
{
    public class MarketBoardSaleCountFilter : StringFilter
    {
        ...
        public override string Name { get; set; } = "Marketboard Sale Counter".Loc();

        public override string HelpText { get; set; } = "Shows the number of sales that have been made within X days.".Loc();
