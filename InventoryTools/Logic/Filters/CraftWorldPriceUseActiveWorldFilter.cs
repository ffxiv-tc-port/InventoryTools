...
public class CraftWorldPriceUseActiveWorldFilter : BooleanFilter
{
    ...
    public override string Name { get; set; } = "Use Active World?".Loc();
    public override string HelpText { get; set; } = "Should your currently logged in character's active world be used as a pricing source?".Loc();
