...
namespace InventoryTools.Logic.Filters
{
    public class SourceAllFreeCompaniesFilter : BooleanFilter
    {
        ...
        public override string Name { get; set; } = "Source - All Free Companies?".Loc();
        public override string HelpText { get; set; } = "Use every free company's inventory as a source.".Loc();
