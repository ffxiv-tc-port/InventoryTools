...
public class CraftDefaultHQRequiredFilter : BooleanFilter
{
    ...
    public override string Name { get; set; } = "HQ Required".Loc();
    public override string HelpText { get; set; } = "Should each item in the list require a HQ version of the item(if applicable)?".Loc();
