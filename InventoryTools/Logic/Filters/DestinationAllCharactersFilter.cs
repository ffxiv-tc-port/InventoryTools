...
namespace InventoryTools.Logic.Filters
{
    public class DestinationAllCharactersFilter : BooleanFilter
    {
        ...
        public override string Name { get; set; } = "Destination - All Characters?".Loc();
        public override string HelpText { get; set; } = "Use every characters inventory as a destination. This will generally only be your own character unless you have cross-character inventory tracking enabled.".Loc();
