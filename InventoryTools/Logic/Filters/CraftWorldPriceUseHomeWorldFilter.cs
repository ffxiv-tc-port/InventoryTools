...
public class CraftWorldPriceUseHomeWorldFilter : BooleanFilter
{
    ...
    public override string Name { get; set; } = "Use Home World?".Loc();
    public override string HelpText { get; set; } = "Should your currently logged in character's home world be used as a pricing source?".Loc();
